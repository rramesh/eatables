...
var file_items_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xd7, 0x02, 0x0a, 0x05, 0x49,
	...
	0x69, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x06, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x12, 0x0c, 0x2e, 0x55, 0x55, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65,
...
var file_items_proto_depIdxs = []int32{
	...
	3,  // 9: Items.Delete:input_type -> UUIDRequest
...
type ItemsClient interface {
	...
	Delete(ctx context.Context, in *UUIDRequest, opts ...grpc.CallOption) (*GenericResponse, error)
}
...
func (c *itemsClient) Delete(ctx context.Context, in *UUIDRequest, opts ...grpc.CallOption) (*GenericResponse, error) {
	out := new(GenericResponse)
...
type ItemsServer interface {
	...
	Delete(context.Context, *UUIDRequest) (*GenericResponse, error)
}
...
func (*UnimplementedItemsServer) Delete(context.Context, *UUIDRequest) (*GenericResponse, error) {
...
func _Items_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ItemsServer).Delete(ctx, req.(*UUIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
